...
export function GlowingTriangles() {
  return (
      ...
      <Suspense fallback={null}>
        <Rig>
          ...
          <Triangle
            ...
            rotation={[0, 0, Math.PI / 3]}
          />
          {/* <Ground mirror={1} mixBlur={10} mixStrength={1} rotation={[-Math.PI / 2, 0, Math.PI / 2]} blur={[300, 120]} position-y={-0.8} /> */}
        </Rig>
